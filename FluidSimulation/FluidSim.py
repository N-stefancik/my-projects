...
viscosity_strength = 0.8  # Strength of viscosity
...
def calculate_gradient(point_x, point_y, predictedPositions, densities, boundary_particles, num_particles, bps, drag_pos, drag_vel):
    ...
    drag_strength = 280  # Base strength of drag force (increased from 60)
    drag_velocity_influence = 1.4  # How much the drag velocity affects particles (new parameter)
